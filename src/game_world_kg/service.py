    ...
    def generate_worldspec(self, idea: str, repair_attempts: int = 2) -> dict[str, Any]:
        with self._lock:
            ...
            trace_payload = {
                ...
                "error_type": getattr(generator, "last_error_type", None),
                "error_message": generator.last_error if generator.last_source == "sample_fallback" else None,
                "pydantic_error": getattr(generator, "last_pydantic_error", None),
                "repair_attempted": getattr(generator, "repair_attempted", False),
                "repair_success": getattr(generator, "repair_success", False),
                "repair_error": getattr(generator, "repair_error", None),
